...
class AllEmployersAdapter(private val context: Context, private val employerList: MutableList<Employer>): RecyclerView.Adapter<AllEmployersAdapter.ViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val itemView = LayoutInflater.from(context).inflate(R.layout.employers_row, parent, false)
        return AllEmployersAdapter.ViewHolder(itemView)
    }
    ...
    class ViewHolder(itemView: View): RecyclerView.ViewHolder(itemView) {
        ...
        fun bindItem(employer: Employer){
            ...
            numOfDaysThisMonth.text = "0"
            numOfDaysWithExcuse.text = "0"
        }
    }
}